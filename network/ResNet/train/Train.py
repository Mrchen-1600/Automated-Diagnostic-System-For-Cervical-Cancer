...
from network.ResNet.model.Model import resnet50
from network.ResNet.config.Config import opt
...
class ModelManager:
    ...
    def _initialize_model(self):
        ...
        model.fc = torch.nn.Linear(in_channel, opt.NUM_CLASSES).to(self.device)
        return model
...
class Trainer:
    ...
    def run_training(self):
        ...
        for epoch in range(opt.EPOCHS):
            ...
            #            os.path.join(opt.WEIGHTS_DIR, f"resnet50-{epoch}.pth"))
